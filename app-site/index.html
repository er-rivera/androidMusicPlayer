            ...
            <div class="tp-banner" >
                <ul>
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        ...
                        <div class="tp-caption large_white_light sfr" data-x="850" data-y="center" data-hoffset="0" data-voffset="-80" data-speed="500" data-start="1600" data-easing="Power4.easeOut">
                            Music
                        </div>
                    ...
                    <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                        ...
                        <div class="tp-caption mediumlarge_light_white sft hidden-xs" data-x="left" data-y="center" data-hoffset="0" data-voffset="0" data-speed="1000" data-start="1200" data-easing="Power4.easeOut">
                           the loading and more of the music.
                        </div>
                        <div class="tp-caption small_light_white sfb hidden-xs" data-x="left" data-y="center" data-hoffset="0" data-voffset="80" data-speed="1000" data-start="1600" data-easing="Power4.easeOut">
                           <p>Cut the streaming and edit your tracks to your <br> liking with a local music player. More updates to come to make this <br>a better experience so you can enjoy your media.</p>
                        </div>
                        ...
                        <div class="tp-caption lfl hidden-xs" data-x="left" data-y="center" data-hoffset="0" data-voffset="160" data-speed="1000" data-start="1800" data-easing="Power4.easeOut">
                            <a href="#" class="btn btn-primary inverse btn-lg">Get For Free</a>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-6">
                        <div class="about-item scrollpoint sp-effect2">
                            ...
                            <h3>Easy setup</h3>
                            <p>Loads all the music for you so can start enjoying the app.</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect5">
                            ...
                            <h3>On-the-go</h3>
                            <p>No need to deal with the hastles of streaming, your music can play whenever you want, where ever you want.</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect5">
                            ...
                            <h3>Organization</h3>
                            <p>Three ways to view your music whether it be by artist, albums, or the song name.</p>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect1">
                            ...
                            <h3>Customization</h3>
                            <p>Change the style of your music to your liking. Future updates will include an equalizer and better options for editing your music.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4 col-sm-4 scrollpoint sp-effect1">
                        <div class="media text-right feature">
                            ...
                            <div class="media-body">
                                <h3 class="media-heading">User Customization</h3>
                                Edit the tags of your tracks.
                            </div>
                        </div>
                        <div class="media text-right feature">
                            <a class="pull-right" href="#">
                    ...
                    <div class="col-md-4 col-sm-4 scrollpoint sp-effect2">
                        ...
                        <div class="media feature">
                            ...
                            <div class="media-body">
                                ...
                                Playback the tracks stored on your phone.
                            </div>
                        </div>
                        ...
                        <div class="media feature">
                            ...
                            <div class="media-body">
                                <h3 class="media-heading">Material Design</h3>
                                Enjoy your music with a material design twist.
                            </div>
                        </div>
                        <div class="media active feature">
                            ...
                            <div class="media-body">
                                <h3 class="media-heading">Future looks bright!</h3>
        ...
        <section id="screens">
            <div class="container">
                ...
                <div class="slider filtering scrollpoint sp-effect5" >
                    <div class="one">
                        <img src="assets/img/freeze/screens/profile.png" alt="">
                        <h4>Profile Page</h4>
                    </div>
                    <div class="two">
                        <img src="assets/img/freeze/screens/menu.png" alt="">
                        <h4>Toggel Menu</h4>
                    </div>
                   
                    <div class="one">
                        <img src="assets/img/freeze/screens/signup.png" alt="">
                        <h4>Sign Up</h4>
                    </div>
                    <div class="one">
                        <img src="assets/img/freeze/screens/calendar.png" alt="">
                        <h4>Event Calendar</h4>
                    </div>
                    <div class="two">
                        <img src="assets/img/freeze/screens/options.png" alt="">
                        <h4>Some Options</h4>
                    </div>
                    <div class="three">
                        <img src="assets/img/freeze/screens/sales.png" alt="">
        ...
        <section id="getApp">
            <div class="container-fluid">
                <div class="section-heading inverse scrollpoint sp-effect3">
                    <h1>Get App</h1>
                    <div class="divider"></div>
                    <p>Download the app on the Play Store today!</p>
                </div>
            ...
            <div class="container">
            	<div class="col-md-4 col-sm-4 contact-details scrollpoint sp-effect2">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading">CS 499 Spring 2017</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a class="pull-left" href="#" >
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading">
                                            <a href="https://github.com/er-rivera/androidMusicPlayer">Link to github page</a>
                                        </h4>
                                    </div>
                                </div>
